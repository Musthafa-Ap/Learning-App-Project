...
class CatagoriesDetailedPage extends StatelessWidget {
  bool? fromSeeAll;
  int cataid;
  CatagoriesDetailedPage({super.key, this.cataid = 1, this.fromSeeAll});
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: catagoriesDetailedProvider.noCatDetailes == true
          ? const Center(
              child: Text(
                "No course",
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    itemCount: catagoriesDetailedProvider
                        .catagoriesDetailes?.data?.length,
                    physics: const BouncingScrollPhysics(),
                    shrinkWrap: true,
                    scrollDirection: Axis.horizontal,
                    itemBuilder: (context, index) {
                      final datas = catagoriesDetailedProvider
                          .catagoriesDetailes?.data?[index];
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    physics: const BouncingScrollPhysics(),
                    itemCount:
                        catagoriesDetailedProvider.subCatagories?.data!.length,
                    shrinkWrap: true,
                    scrollDirection: Axis.horizontal,
                    itemBuilder: (context, index) {
                      final datas = catagoriesDetailedProvider
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final datas = recomendationProvider
