...
class CourseDetailedPage extends StatefulWidget {
  ...
  final int? catid;
  CourseDetailedPage(
      {super.key, this.id, this.refesh = false, this.subcatid, this.catid});
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        if (widget.catid != null) {
          await Provider.of<CatagoriesDetailedProvider>(context, listen: false)
              .getAll(catagoriesID: widget.catid);
        }
        ...
        // await Provider.of<CatagoriesDetailedProvider>(context,
        //         listen: false)
        //     .getAllSub(catagoriesID: widget.id);
        await Provider.of<CatagoriesDetailedProvider>(context, listen: false)
        ...
        await Provider.of<FeaturedProvider>(context, listen: false).samples();
                ...
                if (widget.subcatid != null) {
                  await Provider.of<CatagoriesDetailedProvider>(context,
                      ...
                      .getSubCatagoriesDetailes(
                          subCatagoriesID: widget.subcatid);
                  // await Provider.of<CatagoriesDetailedProvider>(context,
                  //         listen: false)
                  //     .getAll(catagoriesID: widget.id);
                }
                ...
                children: [
                  ...
                  ReadMoreText(
                    courseDeailedProvider
                            .courseDetailes?.data?.first.description
                            .toString() ??
                        "Course description",
                    style: const TextStyle(
                      color: Colors.white,
                  ...
                  token == null
                      ...
                      : Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: OutlinedButton.icon(
                              icon: Icon(
                                courseDeailedProvider.courseDetailes!.data!
                                            .first.isWislist ==
                                        true
                                    ? Icons.favorite
                                    : Icons.favorite_outline,
                                color: courseDeailedProvider.courseDetailes!
                                            .data!.first.isWislist ==
                                        true
                                    ? Colors.red
                                    : Colors.white,
                              ),
                              onPressed: () async {
                                ...
                                if (token == null) {
                                  ...
                                  if (courseDeailedProvider.courseDetailes!
                                          .data!.first.isWislist ==
                                      false) {
                                    if (variant == 1) {
